...
//    // Adjust the column index for which you want to set the data
//    const int targetColumn = 0;  // Replace 0 with the desired column index

//    if (column == targetColumn && data(index, role) != value)
//    {
//        _data[row][column] = value;

...
bool checkData(QList<QVariant> dataRow)
{
    ...
    for (int i = 0; i < dataRow.at(1).toString().size(); ++i)
    {
        if (!dataRow.at(1).toString()[i].isDigit())
        {
            return false;
        }
    }
    for (int i = 0; i < dataRow.at(2).toString().size(); ++i)
    {
        if (!dataRow.at(2).toString()[i].isDigit())
        {
            return false;
        }
    }
    for (int i = 0; i < dataRow.at(4).toString().size(); ++i)
    {
        if (!dataRow.at(4).toString()[i].isDigit())
        {
            return false;
        }
    }
...
void MainWindow::on_addButton_clicked()
{
    ...
    if (ind)
    {
        ...
        if (dialog.exec())
        {
            ...
            {
              QMessageBox::warning(this, "Error", "Invalid data", QMessageBox::Ok);
            }
        }
    }
    else
